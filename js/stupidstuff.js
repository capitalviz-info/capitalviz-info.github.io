...
tour.addStep({
    id: 'example-step',
    text: 'The dots in the middle indicates the venture capital investors. The dot is layouted according to its investments, where the dot will be closer to the companies it invested.',
    attachTo: {
        element: '#pills-funding > div > svg > g > g.node-group > g > circle',
        on: 'left'
    },
